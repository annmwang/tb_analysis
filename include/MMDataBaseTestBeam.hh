...
// Tue Apr 24 11:03:35 2018 by ROOT version 6.08/06
// from TTree vmm/vmm
// found on file: run_0139.root
//////////////////////////////////////////////////////////

#ifndef MMDataBaseTestBeam_h
#define MMDataBaseTestBeam_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MMDataBaseTestBeam(TTree *tree=0);
   virtual ~MMDataBaseTestBeam();
...
inline MMDataBaseTestBeam::MMDataBaseTestBeam(TTree *tree) : fChain(0) 
{
...
inline MMDataBaseTestBeam::~MMDataBaseTestBeam()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t MMDataBaseTestBeam::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t MMDataBaseTestBeam::LoadTree(Long64_t entry)
{
...
inline void MMDataBaseTestBeam::Init(TTree *tree)
{
...
inline Bool_t MMDataBaseTestBeam::Notify()
{
...
inline void MMDataBaseTestBeam::Show(Long64_t entry)
{
...
inline Int_t MMDataBaseTestBeam::Cut(Long64_t entry)
{
